...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['gambar']) && $_FILES['gambar']['error'] === UPLOAD_ERR_OK) {
        ...
        if ($check !== false) {
            ...
            if (!empty($wisata['gambar_wisata']) && file_exists("../gambar/" . $wisata['gambar_wisata'])) {
        ...
        <div class="card">
            <form method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" id="nama" name="nama" value="<?= htmlspecialchars($wisata['nama_wisata']) ?>" required>
                </div>
                <div class="form-group">
                    <label for="lokasi">Lokasi</label>
                    <input type="text" id="lokasi" name="lokasi" value="<?= htmlspecialchars($wisata['lokasi_wisata']) ?>" required>
                </div>
                <div class="form-group">
                    <label for="deskripsi">Deskripsi</label>
                    <textarea id="deskripsi" name="deskripsi" required><?= htmlspecialchars($wisata['deskripsi_wisata']) ?></textarea>
                </div>
                <div class="form-group">
                    ...
                    <?php if (!empty($wisata['gambar_wisata'])): ?>
                        <div class="current-image">
                            <p>Gambar saat ini:</p>
                            <img src="../gambar/<?= htmlspecialchars($wisata['gambar_wisata']) ?>" alt="Current Image">
                        </div>
                    <?php endif; ?>
                </div>
